...
let channel = member.guild.channels.get("500252038769147914");
...
let channel = "500252038769147914"
    ...
    while (!guild)
        ...
        guild = client.guilds.get("500231804024782848");
